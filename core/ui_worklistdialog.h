...
public:
    ...
    void setupUi(QDialog *WorkListDialog)
    {
        ...
        reloadBtn->setGeometry(QRect(9, 20, 101, 31));
        QSizePolicy sizePolicy2(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(reloadBtn->sizePolicy().hasHeightForWidth());
        reloadBtn->setSizePolicy(sizePolicy2);
        reloadBtn->setStyleSheet(QStringLiteral(""));
        QIcon icon;
        icon.addFile(QStringLiteral(":/assets/images/_48_reload.png"), QSize(), QIcon::Normal, QIcon::On);
