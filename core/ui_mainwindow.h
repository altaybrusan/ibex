...
""));
        ...
        QIcon icon16;
        icon16.addFile(QStringLiteral(":/assets/images/_48_worklist_select.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Select->setIcon(icon16);
        ...
        mainMenuBar->setGeometry(QRect(0, 0, 1291, 18));
...
""));
        ...
        menuStudy->addAction(action_Select);
        ...
        studyToolBar->addAction(action_Select);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        action_Select->setText(QApplication::translate("MainWindow", "&Select", Q_NULLPTR));
