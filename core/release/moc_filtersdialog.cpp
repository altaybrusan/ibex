...
#include "../../../../../../../../temp/ibex-master/core/View/filtersdialog.h"
...
QT_MOC_LITERAL(1, 14, 22), // "NotifyItemCheckChanged"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 3), // "row"
QT_MOC_LITERAL(4, 42, 7), // "checked"
QT_MOC_LITERAL(5, 50, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(6, 72, 21) // "on_buttonBox_rejected"

    },
    "FiltersDialog\0NotifyItemCheckChanged\0"
    "\0row\0checked\0on_buttonBox_accepted\0"
...
void FiltersDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FiltersDialog *_t = static_cast<FiltersDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->NotifyItemCheckChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        ...
        {
            typedef void (FiltersDialog::*_t)(int , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FiltersDialog::NotifyItemCheckChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FiltersDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FiltersDialog.data,
      qt_meta_data_FiltersDialog,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void FiltersDialog::NotifyItemCheckChanged(int _t1, bool _t2)
{
