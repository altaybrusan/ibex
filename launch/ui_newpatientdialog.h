...
public:
    ...
    void setupUi(QDialog *NewPatientDialog)
    {
        ...
        NewPatientDialog->resize(700, 545);
        NewPatientDialog->setStyleSheet(QStringLiteral("background-color: rgb(172, 172, 172);"));
        verticalLayout_2 = new QVBoxLayout(NewPatientDialog);
        ...
        verticalLayout_2->addWidget(frame_title);
...
"background-color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QDialog *NewPatientDialog)
    {
        ...
        genderComboBox->insertItems(0, QStringList()
         << QApplication::translate("NewPatientDialog", "Male", Q_NULLPTR)
         << QApplication::translate("NewPatientDialog", "Female", Q_NULLPTR)
         << QApplication::translate("NewPatientDialog", "Unknown", Q_NULLPTR)
        );
