...
#include "../../../launch/bodypartselectionsquare.h"
...
QT_MOC_LITERAL(1, 24, 29), // "NotifyBodyPartIsStatusChanged"
QT_MOC_LITERAL(2, 54, 0), // ""
QT_MOC_LITERAL(3, 55, 14), // "iBEX::BodyPart"
QT_MOC_LITERAL(4, 70, 8), // "bodypart"
QT_MOC_LITERAL(5, 79, 10) // "isSelected"

    },
    "BodyPartSelectionSquare\0"
    "NotifyBodyPartIsStatusChanged\0\0"
    "iBEX::BodyPart\0bodypart\0isSelected"
};
...
void BodyPartSelectionSquare::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->NotifyBodyPartIsStatusChanged((*reinterpret_cast< iBEX::BodyPart(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (BodyPartSelectionSquare::*_t)(iBEX::BodyPart , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BodyPartSelectionSquare::NotifyBodyPartIsStatusChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BodyPartSelectionSquare::NotifyBodyPartIsStatusChanged(iBEX::BodyPart _t1, bool _t2)
{
