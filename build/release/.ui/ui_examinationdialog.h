/********************************************************************************
** Form generated from reading UI file 'examinationdialog.ui'
**
...
#ifndef UI_EXAMINATIONDIALOG_H
#define UI_EXAMINATIONDIALOG_H
...
public:
    ...
    void setupUi(QDialog *ExaminationDialog)
    {
        if (ExaminationDialog->objectName().isEmpty())
            ExaminationDialog->setObjectName(QStringLiteral("ExaminationDialog"));
        ExaminationDialog->resize(1282, 876);
        horizontalLayout = new QHBoxLayout(ExaminationDialog);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        displayFrame = new QFrame(ExaminationDialog);
        ...
        sideFrame = new QFrame(ExaminationDialog);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 414, 219));
...
"color: rgb(0, 255, 0);"));
        ...
        retranslateUi(ExaminationDialog);

        QMetaObject::connectSlotsByName(ExaminationDialog);
    } // setupUi

    void retranslateUi(QDialog *ExaminationDialog)
    {
        ExaminationDialog->setWindowTitle(QApplication::translate("ExaminationDialog", "Exposure Dialog", Q_NULLPTR));
        patientDemographyBox->setTitle(QApplication::translate("ExaminationDialog", "Patients Demography", Q_NULLPTR));
        nameLbl->setText(QApplication::translate("ExaminationDialog", "Full name:", Q_NULLPTR));
        addmissionNumberLbl->setText(QApplication::translate("ExaminationDialog", "Accession", Q_NULLPTR));
        label_5->setText(QApplication::translate("ExaminationDialog", "Birth date:", Q_NULLPTR));
        sexLbl->setText(QApplication::translate("ExaminationDialog", "Sex", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class ExaminationDialog: public Ui_ExaminationDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_EXAMINATIONDIALOG_H
