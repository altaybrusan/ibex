...
#include "../../../plugins/log4qt/simplelayout.h"
...
QT_MOC_LITERAL(1, 21, 9) // "showLevel"

    },
    "Log4Qt::SimpleLayout\0showLevel"
};
...
void Log4Qt::SimpleLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        SimpleLayout *_t = static_cast<SimpleLayout *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->showLevel(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setShowLevel(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
